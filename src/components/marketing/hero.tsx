...
function HeroSection() {
  return (
    <section className="relative grid grid-cols-1 gap-10 px-6 pb-10 sm:px-10 lg:grid-cols-[1fr_minmax(340px,44%)] lg:gap-0 lg:px-14 lg:pb-0">
      {/* LEFT */}
      <div className="relative z-10 flex flex-col pt-4 lg:pt-8">
        ...
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight font-heading mt-8">
          <Balancer>
            ...
            <br />
            {"For your puja & sacred rituals".split(" ").map((word, index) => (
              <motion.span
                initial={{ filter: "blur(10px)", opacity: 0, y: 10 }}
                animate={{ filter: "blur(0px)", opacity: 1, y: 0 }}
      ...
      {/* RIGHT IMAGE */}
      <div className="relative min-h-[440px] lg:min-h-[200px]">
